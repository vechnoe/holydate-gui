...
#ifndef QJULIANCALENDARWIDGET_H
#define QJULIANCALENDARWIDGET_H

#if defined(Q_WS_WIN)
//Windows:
#if defined(QJULIANCALENDARWIDGET_DLL)
#define QJULIANCALENDARWIDGET_EXPORT       __declspec(dllimport)
#elif defined(QJULIANCALENDARWIDGET_MAKE_DLL)
#define QJULIANCALENDARWIDGET_EXPORT       __declspec(dllexport)
#endif

#endif

#if !defined(QJULIANCALENDARWIDGET_EXPORT)
#define QJULIANCALENDARWIDGET_EXPORT
#endif
...
class QJulianCalendarWidgetPrivate;
...
public:
    ...
    explicit QJulianCalendarWidget(QWidget *parent = 0);
...
public Q_SLOTS:
    ...
    // Convert to Julian calendar date.
    void setSelectedDateNeedConvert(const QDate &date);
...
private:
    Q_DECLARE_PRIVATE(QJulianCalendarWidget)
    Q_DISABLE_COPY(QJulianCalendarWidget)
